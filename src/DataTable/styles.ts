...
import { DataTableStyles, Theme, Themes } from './types';

export const defaultStyles = (theme: Theme): DataTableStyles => ({
	table: {
		style: {
...
export const createStyles = (customStyles: DataTableStyles = {}, themeName: Themes = 'default'): DataTableStyles => {
